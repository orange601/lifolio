...
import WaitingQuestionPage from '@/app/legacy/quiz/components/WaitingQuestion';
import QuestionResultPage from '@/app/legacy/quiz/components/QuestionResult';
import QuestionCompletePage from '@/app/legacy/quiz/components/QuestionComplete';
...
export default function QuizPlayPage(
    ...
    const handleNextQuestion = () => {
        ...
        const correctIdx = currentQ.correctOrderNo ?? 0;
    ...
    if (showResult) {
        const current = quizData[currentQuestion];
        const correctIdx = current.correctOrderNo ?? 0;
        const isCorrect = selectedAnswer === correctIdx;
